...
public:
	...
	Mat& get_AffineTransform();

	AffineTransform operator*(AffineTransform &D);
	AffineTransform();
...
public:
	...
	Tham số
	 ...
	 - maintain_src_size: bằng 1 nghĩa là giữ nguyên kích thước ảnh và ngược lại
	Trả về:
	...
	*/
	...
	- direction = 1 nếu lấy đối xứng theo trục ngang (Ox) và direction = 0 nếu lấy đối xứng theo trục đứng (Oy)
	- interpolator: biến chỉ định phương pháp nội suy màu
	Trả về:
	 - 0: Nếu ảnh input ko tồn tại hay ko thực hiện được phép biến đổi
	 - 1: Nếu biến đổi thành công
